...
function tieneEmail(usuario) {
  ...
  if (usuario.email !== undefined && usuario.email !== null) {
    return true;
  } else if (usuario.email === undefined || usuario.email == null) {
    return false;
  }
}
...
function pasarUsuarioAPremium(usuarios) {
  ...
  // Tu código:
  validar = usuarios.map(function (i) {
    i.esPremium = true;
  });
  return usuarios;
}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  function calcularPrecioDescuento(){
    let product = this.precio - (this.precio * this.porcentajeDeDescuento)
    producto.precioConDescuento = product;
     return product;
 }
